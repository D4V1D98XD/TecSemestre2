...
public class Empleado extends Persona implements Serializable{
	...
	public Empleado(int edad, String nombre, char genero, char tipoempleado, int numdepartamento, int sueldo, String fecha, int dias) {
	...
	public static String nombres() {
		...
		String[] nombres = {"Leo", "Jesus", "Miriam", "Carolina", "Pepe", "Barbero", "Harry", "Dandi", "Tachu", "Adrian"};
